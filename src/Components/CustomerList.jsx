...
class CustomerList extends Component {
  render() {
    ...
    const colorThemes = [
      { bg: "#DBE1FF", text: "#346EF6" },
      { bg: "#FFDBCD", text: "#C9510D" },
            ...
            data.map((item, index) => (
              ...
              <div key={index} className='bg-[#FFFFFF] rounded-2xl p-6 shadow-xl'>
                <div className='flex items-center justify-between mb-4'>
                  {/* Name Initials */}
                  <div className='font-bold w-12 h-12 rounded-full flex items-center justify-center text-lg' style={{
                    backgroundColor: colorThemes[index % colorThemes.length].bg,
                ...
                <div className='flex items-center justify-between border-t border-[#E1E3E4] pt-6 px-15'>
                  ...
                  <div className='flex items-center justify-start cursor-pointer'>
                    ...
                    <button onClick={() => deleteItem(index)} className='text-[#581E00] text-xs font-bold ml-2 cursor-pointer'>Delete</button>
                  </div>
                </div>
              </div>
            ))}
